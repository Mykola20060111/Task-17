...
function addItems() {
  ...
  createItem(300, 100, 'star');
  createItem(450, 250, 'star');
  createItem(600, 350, 'star');
  createItem(200, 450, 'star');
  createItem(350, 500, 'star');
}
...
function addPlatforms() {
  ...
  platforms.create(200, 350, 'platform2');
  platforms.create(650, 150, 'platform2');
...
window.onload = function () {
  ...
  function update() {
    ...
    if (currentScore >= winningScore) {
      alert("Вітаю! Ви виграли, зараз гра перезапуститься.");
      location.reload();
      currentScore = 0;
      won = false;
      badges.destroy();
